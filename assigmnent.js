//github.com/Samapti-Nag-Bindu/assignment-three-problem-solving.git

// Kilometer to Meter Converter
https: https: https: function kilometerToMeter(kilometer) {
  if (kilometer >= 0) {
...
function megaFriend(friendsArray) {
  if (Array.isArray(friendsArray) && friendsArray.length > 0) {
    ...
    return "Please provide an array with minimum one value";
  }
}
